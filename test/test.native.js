...
tape( 'the function evaluates the logpdf for `x` given large parameter `alpha`', opts, function test( t ) {
	var expected;
	var delta;
	var alpha;
	var beta;
...
tape( 'the function evaluates the logpdf for `x` given large parameter `beta`', opts, function test( t ) {
	var expected;
	var delta;
	var alpha;
	var beta;
